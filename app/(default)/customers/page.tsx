          ...
          <div className="pt-32 md:pt-40">
            ...
            <div className="text-center pb-12 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-slate-400">Stonefort powers thousands of high-impact product teams. From next-gen startups who reach for the stars to established greats who change the world.</p>
              </div>
            </div>
